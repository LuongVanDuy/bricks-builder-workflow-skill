...
def build_theme_style(
    ...
    settings: dict[str, object] = {
        ...
        "contextualSpacing": {
            ...
            "contextualSpacingHeading": variable("space-xl"),
            "contextualSpacingParagraph": variable("space-m"),
            "contextualSpacingFallback": variable("space-l"),
        },
        "typography": {
            "typographyHtml": "62.5%",
            ...
            "typographyHeadingH1": typography(size="text-2xl"),
            "h1Margin": zero,
            "typographyHeadingH2": typography(size="text-xl"),
            "h2Margin": zero,
            "typographyHeadingH3": typography(size="text-l"),
            "h3Margin": zero,
            "typographyHeadingH4": typography(size="text-m"),
            "h4Margin": zero,
            "typographyHeadingH5": typography(size="text-s"),
            "h5Margin": zero,
            "typographyHeadingH6": typography(size="text-xs"),
            "h6Margin": zero,
        ...
        "button": {
            ...
            "outlineBorder": rounded_border("primary", "1px"),
            ...
            "primaryOutlineBorder": rounded_border("primary", "1px"),
        ...
        "form": {
            ...
            "fieldBorder": rounded_border("border", "1px"),
